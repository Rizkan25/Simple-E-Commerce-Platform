                    ...
                    <div class="space-y-5">
                        ...
                        <div class="pt-2">
                            <label for="is_cod_enabled" class="inline-flex items-center">
                                <input id="is_cod_enabled" type="checkbox" class="rounded border-gray-300 text-indigo-600 shadow-sm focus:ring-indigo-500" name="is_cod_enabled" value="1" {{ old('is_cod_enabled', true) ? 'checked' : '' }}>
                                <span class="ml-2 text-sm text-gray-600 font-medium">{{ __('Aktifkan Pembayaran COD (Cash On Delivery) untuk produk ini') }}</span>
                            </label>
                        </div>

                        <!-- Discount -->
                        <div x-data="{ discountType: '{{ old('discount_type', '') }}' }" class="p-4 border rounded-lg bg-gray-50">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                <div x-show="discountType !== ''" x-cloak>
                                    ...
                                    <x-text-input id="discount_amount" class="block mt-1 w-full" type="number" name="discount_amount" :value="old('discount_amount')" min="0" step="0.01" />
