        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            @else
                <div class="text-center py-16 bg-white rounded-xl shadow-sm">
                    ...
                    <a href="{{ route('seller.products.create') }}" class="inline-block mt-4 px-6 py-2 bg-indigo-600 text-white rounded-lg hover:bg-indigo-700 transition">Tambah Produk</a>
                </div>
            @endif
        </div>
    </div>
